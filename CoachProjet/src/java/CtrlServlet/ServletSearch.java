    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             //write the page XML
                ...
                out.println("<donnees>");
                //get the param
                String mot = request.getParameter("saisieNom");

                if(mot!=""){
                try{
                    //get the result
                    List<Client> lstclients = HibernateMethode.verifierClient(mot);
                    List<Client> lstcliP = HibernateMethode.consultClientPgrm();
                    ArrayList<Integer> listidPgrm = new ArrayList<Integer>();

                    for(Client cp : lstcliP){
                        listidPgrm.add(cp.getIdc());
                    }
//                    System.out.println(listid.contains(c.getIdc()));
                        if(lstclients!=null){
                            ...
                            if(listidPgrm.contains(c.getIdc())){
                                out.println("<type>true</type>");
                            }else{
                                out.println("<type>false</type>");
                            }
                            out.println("</client>");
                            }
                        }
