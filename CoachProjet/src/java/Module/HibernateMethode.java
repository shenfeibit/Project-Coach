...
/**
 *
 * @author Tong/Jiayu/Nassiba/Fei
 */
public class HibernateMethode {

    //function to get all infomation of the client with id
    ...
    //function to get the objecties choosed by a client
    ...
    //function to get the programme perso of a client
    ...
    //function to get the seances persos with the order of a programme perso
    ...
    //function to get the seances standards with the order of a programme standard
    ...
    //function to get all the objecties
    ...
    //function to get the programmes corresponding of an objectif
    ...
    //function to calcule the progression of the programme of the client
    ...
    //function to get all the clients with programme
    ...
    //function to get all the client without programme
    ...
    //function to get the date of choose a objectif for a client
    ...
    //function to save the affectation of an programme to a client
    ...
    //function to get the exercises with order for un seances perso
    ...
    //function to control the connexion of client
    ...
    //function to control the connexion of coach
    ...
    //function to get the name of a seances
    ...
    //function to get the infomations of a exercise with a given id
    ...
    //function to get the order of id exercese with a given seance
    ...
    //function to get the clients within the enter a part of nom
    ...
    //function to get the evoluation (the name of performance, list of the ecoluation of first and last seance bilan) of a client
    ...
    //function to save the performance of a exercise perso
    ...
    //function to save the date of a seance perso when it finished
    ...
    //function to get the client of a given seance
    ...
    //function to save the mensurations de seance bilan
    ...
    //functiion to save the performances of seance bilan
    ...
    //function to save the time or number of repeat for a exercise
    ...
    //function to controle whether the seance is a seance bilan
